...
<div id="tab-auditions" class="tab">
	...
	<div class="wait">PROCESSING....PLEASE WAIT!!!</div>
		<g:formRemote name="stage1_form" url="[controller:'production',action:'update_profiles']" 
			...
			<div class="cell float-left"> <g:submitButton name="Save Changes" id="submit_headshots_top" class="submit action_wait"/></div>
			...
			<div class="cell float-left"> <g:submitButton name="Save Changes" id="submit_headshots_bottom" class="submit action_wait"/></div>
		</g:formRemote>	
