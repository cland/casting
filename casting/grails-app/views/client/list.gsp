			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="client.company.label" default="Company" /></th>
				...
				<g:each in="${clientInstanceList}" status="i" var="clientInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${clientInstance.id}">${fieldValue(bean: clientInstance, field: "company")}</g:link></td>
