...
<g:set var="faviconImageInstance" value="${com.cland.casting.Image.findByName('$favicon')}"/>
...
<g:set var="logoImageInstance" value="${com.cland.casting.Image.findByName('$logo')}"/>
<g:set var="logoLink" value="${resource(dir: 'images', file: 'favicon.ico')}"/>
