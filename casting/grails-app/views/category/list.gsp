			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="lastUpdatedBy" title="${message(code: 'category.lastUpdatedBy.label', default: 'Last Updated By')}" />
					
						<g:sortableColumn property="createdBy" title="${message(code: 'category.createdBy.label', default: 'Created By')}" />
