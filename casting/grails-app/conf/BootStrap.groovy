...
//					def picseta = new PictureSet(name:"Pic Candy Set1")
//					def picsetb = new PictureSet(name:"Pic Sony Set2")
//					def vidseta = new VideoSet(name:"Vid Candy Set1")
//					def vidsetb = new VideoSet(name:"Vid Sony Set2")
//					cand2.addToPictures(picseta)
//					cand2.addToPictures(picsetb)
//					cand2.addToVideos(vidseta)
//					cand2.addToVideos(vidsetb)
